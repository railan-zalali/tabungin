...
export function useTheme() {
    ...
    const colors = {
        ...
        brutalInk: isDark ? BaseColors.dark.brutalInk : BaseColors.brutalInk,
        brutalPaper: isDark ? BaseColors.dark.brutalPaper : BaseColors.brutalPaper,
        brutalPaperAlt: isDark ? BaseColors.dark.brutalPaperAlt : BaseColors.brutalPaperAlt,
        brutalWhite: isDark ? BaseColors.dark.brutalWhite : BaseColors.brutalWhite,
        brutalLime: BaseColors.brutalLime,
        brutalYellow: BaseColors.brutalYellow,
        brutalRed: BaseColors.brutalRed,
        brutalBlue: BaseColors.brutalBlue,
        brutalGreen: BaseColors.brutalGreen,
        brutalPink: BaseColors.brutalPink,
        brutalPurple: BaseColors.brutalPurple,
        brutalGray: isDark ? BaseColors.dark.brutalGray : BaseColors.brutalGray,
